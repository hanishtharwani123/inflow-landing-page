// components/InfluenceWithoutLimitsSection.tsx
import React from "react";

const InfluenceWithoutLimitsSection: React.FC = () => {
  return (
    <section
      className="relative w-full py-6 px-3 xs:py-8 xs:px-4 sm:py-12 sm:px-6 md:py-16 md:px-8 lg:py-24"
      style={{ backgroundColor: "#582474" }}
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 xs:gap-6">
        ...
        <div className="w-full md:w-2/3 text-center md:text-left order-1 md:order-2">
          ...
          >
            From creators to brands to marketers, Inflow.chat is built for those
            who want to grow with strategy, precision, and automation.
          </p>
          ...
          <div className="space-y-1 xs:space-y-2 sm:space-y-4 mb-3 xs:mb-4 sm:mb-6">
            <div className="flex items-center justify-center md:justify-start space-x-1 xs:space-x-2 sm:space-x-3">
              ...
              >
                <svg
                  className="w-1.5 h-1.5 xs:w-2 xs:h-2 sm:w-3 sm:h-3 text-[#582474]"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
              ...
              >
                For Content Creators – A smarter way to manage audience
                engagement.
              </span>
            </div>
            <div className="flex items-center justify-center md:justify-start space-x-1 xs:space-x-2 sm:space-x-3">
              ...
              >
                For Businesses – Drive conversions and optimize marketing
                performance.
              </span>
            </div>
            <div className="flex items-center justify-center md:justify-start space-x-1 xs:space-x-2 sm:space-x-3">
              ...
              >
                For Influencers – Maximize reach with intelligent insights.
              </span>
            </div>
          </div>
...
export default InfluenceWithoutLimitsSection;
